...
Models = dict(
    ...
    LeNet5_Tensor_Fashion_Mnist_R3=LeNet5_Tensor_Fashion_Mnist_R3,
    LeNet5_Tensor_Fashion_Mnist_R5=LeNet5_Tensor_Fashion_Mnist_R5,
    LeNet5_Tensor_Fashion_Mnist_R10=LeNet5_Tensor_Fashion_Mnist_R10,
    LeNet5_Tensor_Fashion_Mnist_R15=LeNet5_Tensor_Fashion_Mnist_R15,
    LeNet5_Tensor_Fashion_Mnist_R20=LeNet5_Tensor_Fashion_Mnist_R20,
    LeNet5_Tensor_Fashion_Mnist_Rsearch=LeNet5_Tensor_Fashion_Mnist_Rsearch,
)
...
def main(args):
    ...
    if args.model in Models:
        model = Models[args.model](dataset_path=dataset_path, num_classes=10, init=args.init, seed=args.seed, rank=ranks)
    else:
    ...
    runner.test(model, model_path=args.pre_train_model_path, test_callbacks=valing_metrics)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, default="LeNet5_Tensor_Fashion_Mnist_Rsearch")
    parser.add_argument("--init", type=str, default="ours_conv_relu")

    parser.add_argument("--epochs", type=int, default=20)

    parser.add_argument('--pre-train-model-path', type=str, default='./PSTRN_id640_code_and_data/save/FashionMNIST/PSTRN-M/checkpoint/model-nn-best-val-top-1.pt',
    ...
    parser.add_argument("--rank", type=str, default="8,14,8,18,14,18,22,28,6,24,20,14,20,20,10,22,20,20,6,20")
