...
from model.resnet_tr_cifar100 import *


Models = dict(
    resnet32_tr_cifar100_rsearch=resnet32_tr_cifar100_rsearch,
    resnet20_tr_cifar100_rsearch=resnet20_tr_cifar100_rsearch,
)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, default="resnet32_tr_cifar100_rsearch")
    parser.add_argument("--init", type=str, default="ours_res_relu")

    parser.add_argument("--epochs", type=int, default=200)

    parser.add_argument("--rank", type=str, default="4, 8, 6, 8, 12, 12, 10")

    parser.add_argument('--pre-train-model-path', type=str,
                        default="./PSTRN_id640_code_and_data/save/CIFAR100/Res32/PSTRN-M/checkpoint/model-nn-best-val-top-1.pt",
