...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default='./PSTRN_id640_code_and_data/validation/datasets/HMDB51/data_feature_pkls/')
    parser.add_argument("--model", type=str, default="ClassifierFeatureTR")
    parser.add_argument("--init", type=str, default="truncguass_3")
    parser.add_argument("--rank", type=str, default="52, 17, 34, 37")
    parser.add_argument("--dropih", type=float, default=0.25)

    parser.add_argument("--epochs", type=int, default=300)

    parser.add_argument('--pre-train-model-path', type=str, default="./PSTRN_id640_code_and_data/save/HMDB51/PSTRN-M/checkpoint/model-nn-best-val-top-1.pt",
